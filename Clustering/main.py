...
#print(X[:,0]) :는 모든 것 선택한다는뜻 즉, X[:,0]은 X의 모든행 1열요소들을 가져온다는뜻
...
#init= 초기중심지정 랜덤이나 k-means++ n_clusters= 클러스터개수 n_init= 반복횟수
...
cluster_centers = kmeans.cluster_centers_ # 클러스터중심가져오기
