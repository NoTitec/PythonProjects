...
resultgreedy=greedy(EigthPuzzleProblem(INITIAL))
resultuniform=uniform_cost(EigthPuzzleProblem(INITIAL))
...
for action, state in result.path():
    ...
    print(state)
print("greedy")
for action,state in resultgreedy.path():
    print('Move number', action)
    print(state)
print("uniform")
for action,state in resultuniform.path():
    print('Move number', action)
    print(state)